...
// Esquema para actualizar un taller
...
// Esquema para filtros de talleres
export const filtrosTalleresSchema = z.object({
  titulo: z.string()
    .max(150, 'El título no puede exceder 150 caracteres')
    .optional(),
...
// Esquema para validar ID de taller
export const idTallerSchema = z.object({
  id: z.string()
