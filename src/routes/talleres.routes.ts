 ...
 *         titulo:
 *           type: string
 *           description: Título del taller
 *           maxLength: 150
 *           example: "Introducción a React"
 *         descripcion:
 *           type: string
 *           description: Descripción detallada del taller
 *           example: "Aprende los fundamentos de React para desarrollo web moderno"
 *         cupo:
 *           type: integer
 ...
 *           type: string
 *           format: date-time
 *           description: Fecha y hora del taller
 ...
 *           type: string
 *           format: date-time
 *           description: Fecha y hora del taller (debe ser futura)
 *           example: "2024-03-15T14:00:00Z"
 *         id_categoria:
 *           type: integer
 ...
 *           description: Descripción detallada del taller
 *           minLength: 1
 *           example: "Aprende los fundamentos de React y hooks para desarrollo web moderno"
 *         cupo:
 *           type: integer
 *           description: Número máximo de participantes
 *           minimum: 1
...
router.post('/', authenticateToken, requireAnyPermission(['talleres:create', 'talleres:*']), async (req: Request, res: Response, next) => {
  try {
    ...
    const insertQuery = `
      INSERT INTO talleres (titulo, descripcion, cupo, horario, id_categoria)
      VALUES ($1, $2, $3, $4, $5)
      RETURNING id_taller, titulo, descripcion, cupo, horario, id_categoria, creado_en
    `;
