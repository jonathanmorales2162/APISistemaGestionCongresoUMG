 ...
 *           maxLength: 150
 *           example: "Hackathon de Innovación"
 *         descripcion:
 *           type: string
 *           description: Descripción detallada de la competencia
 *           example: "Competencia de desarrollo de soluciones innovadoras en 48 horas"
 *         cupo:
 *           type: integer
 ...
 *           type: string
 *           format: date-time
 *           description: Fecha y hora de la competencia
 ...
 *           type: string
 *           format: date-time
 *           description: Fecha de creación de la competencia
 ...
 *           type: string
 *           format: date-time
 *           description: Fecha y hora de la competencia (debe ser futura)
 *           example: "2024-03-20T09:00:00Z"
 *         id_categoria:
 *           type: integer
 ...
 *           minLength: 1
 *           maxLength: 150
 *           example: "Hackathon de Innovación - Actualizado"
 *         descripcion:
 *           type: string
 *           description: Descripción detallada de la competencia
 *           minLength: 1
 *           example: "Competencia de desarrollo de soluciones innovadoras con IA en 48 horas"
 *         cupo:
 *           type: integer
 *           description: Número máximo de participantes
 *           minimum: 1
